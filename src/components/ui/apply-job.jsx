...
const ApplyJobDrawer = ({job, applied = false, user, fetchJob}) => {
    const {
        register,
        handleSubmit,
        control,
    ...
    const onSubmit = (data) => {
        fnApply({
            ...
            fetchJob(); // This will refresh the job data and update hasApplied
            reset();
        })
    }
        ...
        <Drawer open={applied ? false : undefined}>
            <DrawerTrigger asChild>
                <Button 
                    ...
                    disabled={!job?.isOpen || applied} // Disable if job is closed OR already applied
                    size="lg"
                    className="w-full h-12 px-8 text-base font-medium"
                >
